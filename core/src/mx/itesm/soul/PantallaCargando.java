...
class PantallaCargando extends Pantalla {
    ...
    private mx.itesm.soul.ColourlessSoul juego;
    private mx.itesm.soul.Pantallas siguientePantalla;
...
//
    ...
    private void actualizarCargaRecursos() {
        if (manager.update()) { // Terminó?
            switch (siguientePantalla) {
                case INTRO:
                    juego.setScreen(new mx.itesm.soul.PantallaIntro(juego));   // 100% de carga
                    break;
                case MENU:
                ...
                case NIVEL_1: case NIVEL_2: case NIVEL_3: case NIVEL_4: case NIVEL_FINAL:
                    ...
                    break;
                case AJUSTES:
                    juego.setScreen(new mx.itesm.soul.PantallaAjustes(juego));   // 100% de carga
                    break;
                case EXTRAS:
                    juego.setScreen(new mx.itesm.soul.PantallaExtras(juego));   // 100% de carga
                    break;
                case CREDITOS:
                    juego.setScreen(new mx.itesm.soul.PantallaCreditos(juego));   // 100% de carga
                    break;
                case LOGROS:
                    if(tiempoVisible<=0)
                    ...
                    break;
                case GAMEOVER:
                    juego.setScreen(new mx.itesm.soul.PantallaGameOver(juego));   // 100% de carga
                    break;
                case GANASTE:
                    juego.setScreen(new mx.itesm.soul.PantallaGanaNivel(juego));   // 100% de carga
                    break;
                case TUTORIAL:
                    if(tiempoVisible<=0)
                        juego.setScreen(new mx.itesm.soul.PantallaTutorial(juego));   // 100% de carga
                    break;
            }
        }
    }
